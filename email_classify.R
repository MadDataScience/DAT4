...
# Original Author: Drew Conway (drew.conway@nyu.edu)
# Modified Date:   2014-02-23
# Modified By:     Alessandro Gagliardi (adfgagliardi@gmail.com)
# Data Used:       Email messages contained in data/ directory, 
...
spam2.path <- file.path("Classification_data", "spam_2")
easyham.path <- file.path("Classification_data", "easy_ham")
easyham2.path <- file.path("Classification_data", "easy_ham_2")
hardham.path <- file.path("Classification_data", "hard_ham")
hardham2.path <- file.path("Classification_data", "hard_ham_2")
